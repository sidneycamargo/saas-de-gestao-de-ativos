...
export default function Register() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (error) {
      ...
      toast({
        title: 'Erro',
        description: 'Ocorreu um erro ao tentar usar o Google.',
        variant: 'destructive',
      })
    }
  }
          ...
          <CardContent>
            <div className="space-y-4 mb-6">
              <Button
                ...
                className="w-full bg-white text-slate-900 hover:bg-slate-100 hover:text-slate-900 border-transparent font-medium"
              >
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-slate-950 px-2 text-slate-400">Ou registre com e-mail</span>
                </div>
              </div>
            </div>
